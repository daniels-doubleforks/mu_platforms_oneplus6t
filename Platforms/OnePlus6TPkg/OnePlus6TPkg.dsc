...
[BuildOptions]
  DEBUG_CLANG38_AARCH64_CC_FLAGS = -Wno-error=unaligned-access -Wunused-but-set-variable
  RELEASE_CLANG38_AARCH64_CC_FLAGS = -Wno-error=unaligned-access -Wunused-but-set-variable
