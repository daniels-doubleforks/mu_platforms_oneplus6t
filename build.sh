...
export PATH="$PATH:~/MuToolChain/gcc-linaro-7.4.1-2019.02-x86_64_aarch64-linux-gnu/bin"
sudo update-alternatives --install /usr/bin/gcc gcc ~/MuToolChain/gcc-linaro-7.4.1-2019.02-x86_64_aarch64-linux-gnu/bin/aarch64-linux-gnu-gcc 70
sudo update-alternatives --install /usr/bin/gcc-ar gcc-ar ~/MuToolChain/gcc-linaro-7.4.1-2019.02-x86_64_aarch64-linux-gnu/bin/aarch64-linux-gnu-gcc-ar 70
cd ..
mkdir venv
